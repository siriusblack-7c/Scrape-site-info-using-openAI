...
function StepCard({
    ...
    return (
        ...
        >
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center text-sm font-medium !text-gray-200">
                        ...
                        {testing && currentStep === index && (
                            <svg className="animate-spin h-5 w-5 !text-indigo-100 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            {result && (
                <div className={`mt-2 text-sm ${result.status === 'success' ? 'text-gray-200 bg-green-500 w-[80px] text-center rounded-md' : 'text-gray-200 bg-red-500 w-[80px] text-center rounded-md'}`}>
